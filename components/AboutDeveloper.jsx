          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                Mahindra Lifespaces is a well-known real estate company in India and is part of the Mahindra Group. Started in 1994, the company has built many good-quality homes, townships, and industrial spaces in cities like Mumbai, Pune, Chennai, Bengaluru, and Delhi-NCR. Their focus is on building strong and modern homes that improve people's lifestyle. They also believe in green building practices, using eco-friendly methods like rainwater harvesting and energy-saving systems in their projects.
              </p>
            </div>
