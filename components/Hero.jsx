    ...
    <section className="hero-container">
      ...
      <div className="hero-content">
        ...
        <p className="hero-subtitle">
          <span style={{ fontSize: '0.85em', fontWeight: 500, textTransform: 'none' }}>At Malad West, Mumbai</span>
        </p>
        {/* Bullet Points */}
        <div className="hero-bullets" style={{ marginBottom: '24px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            'EOI Amount - ₹5 Lakh*',
            'Flexible Payment For 100 Customers',
            'Low-Density & Luxurious Project'
          ].map((text, i) => (
        ...
        <div className="hero-cta-row" style={{ marginTop: '16px' }}>
          ...
          >
            Price starts <span className="hero-price-amt" style={{ fontSize: '15px', marginLeft: '6px' }}>₹ 2.62 Cr*</span>
          </div>
