    ...
    <nav style={{
      ...
      <div style={{
        ...
        <a href="#" style={{ flexShrink: 0, display: 'flex', alignItems: 'center' }}>
          <style>{`
            .nav-logo { height: 53px; width: auto; display: block; object-fit: contain; transform: scale(1.3, 1.15); transform-origin: center; }
            @media(max-width: 768px) {
              .nav-logo { height: 45px; transform: scale(1.2, 1.1); }
            }
          `}</style>
          <img
            src={logoImages.tarc}
            alt="Mahindra Marina 64"
            className="nav-logo"
          />
        </a>
